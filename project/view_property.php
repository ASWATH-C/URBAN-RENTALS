...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <!-- Map Link open in new tab-->
   
      <p class="location"><i class="fas fa-map-marker-alt"></i>
      <a href="<?= $fetch_property['map_link']; ?>" target="_blank"><?= $fetch_property['map_link']; ?></a></p>
   
      <!-- Map show in same page Iframe-->
      <!--
      <p class="location"><i class="fas fa-map-marker-alt"></i>
      <div class="map-container">
        <iframe src="<?= $fetch_property['map_link']; ?>" width="100%" height="400" frameborder="0" style="border:0;"></iframe>
      </div>
   -->
