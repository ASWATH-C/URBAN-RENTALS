...
if(isset($_POST['post'])){
   ...
   if($image_01_size > 2000000){
      ...
      $insert_property->execute([$id, $user_id, $property_name, $address, $map_link, $price, $type, $offer, $status, $furnished, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="text" name="map_link" required maxlength="100" placeholder="enter map link..." class="input">
         </div>
         <div class="box">
